...
namespace CameronKeetch_Assignment10
{
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute("teampagenum",
                    "TeamName/{teamid}/{teamname}/{pagenum}", new { Controller = "Home", action = "Index" });

                endpoints.MapControllerRoute("pagenume",
                    "{pagenum}", new { Controller = "Home", action = "Index" });
